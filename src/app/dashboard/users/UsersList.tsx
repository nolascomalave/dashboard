                    ...
                    {users.map((user, key: number) => (
                        <div key={key} className="flex justify-center">
                            <UserCard
                                session={session}
                                User = {user}
                                CurrentUser = {(!!session && !!session.user && user.system_subscription_user_id === session.user.id) ? session.user : null}
                                hrefEdit = {`/dashboard/users/edit/${user.system_subscription_user_id}`}
